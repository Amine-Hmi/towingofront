          ...
          >
            <View style={style.historyListView}>
              <HistoryList
                ...
                price="75.00"
                status="Confirm"
                statusText={{ color: Color.purple, fontFamily: "UberMoveText-Bold" }}
              />
            </View>
            <View style={style.historyListView}>
              <HistoryList
                ...
                price="75.00"
                status="Completed"
                statusText={{ color: Color.green, fontFamily: "UberMoveText-Bold" }}
              />
            </View>
            <View style={style.historyListView}>
              <HistoryList
                ...
                status="Cancelled"
                onPress={() => this.props.navigation.navigate("Home")}
                statusText={{ color: Color.steel, fontFamily: "UberMoveText-Bold" }}
              />
            </View>
            <View style={style.historyListView}>
              <HistoryList
